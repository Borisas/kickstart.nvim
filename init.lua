...
require('lazy').setup({
  ...
  --
  {
    ...
    config = function()
      require('nvim-web-devicons').setup {
        -- Optional: globally enable different highlight colors per icon (default to true)
        -- if set to false, all icons will have the default icon's color
        color_icons = true,
        -- Optional: globally enable default icons (default to false)
  ...
  { -- File explorer
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>tf', ':NvimTreeFocus<CR>', { desc = 'Focus NvimTree', silent = true })
    end,
  },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>x', vim.lsp.buf.code_action, '[X]Code Actions')
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      local has_words_before = function()
        ...
        local character = vim.api.nvim_buf_get_lines(0, line - 1, line, true)[1]:sub(col, col)
        return character:match '%a' ~= nil
      end
